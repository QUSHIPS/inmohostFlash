...
function jBoxImageWrapper(jBox, jQuery) {
  ...
  new jBox.plugin('Image', {
    ...
    imageCounterSeparator: '/',  // HTML to separate the current image number from all image numbers, e.g. '/' or ' of ' SEPARADOR DE NRO IMAGEN
    downloadButton: true,       // Adds a download button
